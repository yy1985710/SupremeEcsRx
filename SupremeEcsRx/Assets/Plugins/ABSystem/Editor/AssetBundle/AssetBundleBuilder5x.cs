...
namespace NO1Software.ABSystem.Editor
{
    public class AssetBundleBuilder5x : ABBuilder
    {
        ...
        public override void Export()
        {
            ...
            //开始打包
            BuildPipeline.BuildAssetBundles(AssetBundleBuildPath.BundleSavePath, list.ToArray(), BuildAssetBundleOptions.ChunkBasedCompression, EditorUserBuildSettings.activeBuildTarget);

#if UNITY_5_1 || UNITY_5_2
            AssetBundle ab = AssetBundle.CreateFromFile(pathResolver.BundleSavePath + "/AssetBundles");
#else
            AssetBundle ab = AssetBundle.LoadFromFile(AssetBundleBuildPath.BundleSavePath + "/AssetBundles");
#endif
