...
namespace NO1Software.ABSystem
{
    ...
    public class MobileAssetBundleLoader : AssetBundleLoader
    {
        ...
        {
            _assetBundleCachedFile = string.Format("{0}/{1}", AssetBundlePathResolver.Instance.BundleCacheDir, bundleName);
            _assetBundleSourceFile = AssetBundlePathResolver.Instance.GetBundleSourceFile(bundleName);
